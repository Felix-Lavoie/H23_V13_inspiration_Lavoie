...
Plusieurs élément font en sorte que cette oeuvre puisse fonctioner

<img width="500px" src="./media/preferer/photo_Edria/photo_cache_fil_1.jpg">
- des cache fils

<img width="500px" src="./media/preferer/photo_Edria/photo_capteur_pillier_millieux.jpg">
- quatre capteure de mouvements

<img width="500px" src="./media/preferer/photo_Edria/photo_eclairage_1.jpg">
- des spot lumineu et des speakers

<img width="500px" src="./media/preferer/photo_Edria/photo_protege_fil_1.jpg">
- des protège fils

## Éléments nécesaires à la mise en exposition
- des fils
- un ordinateur
- des cache fils
- un espace extérieur qui ressemble a un rond

## Expérience vécue
Les visiteurs peuvent arriver sur place et se promener autour du pilluer princpale et ils vont voir plusieurs effet ce produire celon combien de personne s'ont autour du pillier principale (il faut une personne sur chaqu'un des quatre coté du pillier centrale pour une expériance totale). Noter qu'il est possible d'allumer tout les capteurs soit même en mattant ses main de l'autre coté du pillier pour l'expériance complète.
...
## Ce que j'auras fat différament
Je trouve que les protège fils créaient trop de contraste dut a leur couleur jaune, j'aurais donc essayer de trouver des cache fils différent ou essayer de trouver une autre façon de protégé les fils.
